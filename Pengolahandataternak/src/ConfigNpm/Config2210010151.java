 ...
 * @author ASUS
 */
public class Config2210010151 {
    
    private String jdbcUrl = "jdbc:mysql://localhost:3306/2210010151_nopalaswin_pbo2";
    ...
    public void HapusDinamis(String NamaTabel, String PK, String isi){
     ...
     public void settingJudulTabel(JTable Tabelnya, String[] JudulKolom){
      ...
      try {
         Statement perintah = getKoneksiNPM().createStatement(
            ResultSet.TYPE_SCROLL_INSENSITIVE, // Mengizinkan navigasi maju-mundur
            ResultSet.CONCUR_READ_ONLY         // Data hanya bisa dibaca
         );
      ...
      try {
          ...
          JasperDesign jasDes = JRXmlLoader.load(file);
           ...
           JasperPrint JP = JasperFillManager.fillReport(JR,null,getKoneksiNPM()); 
